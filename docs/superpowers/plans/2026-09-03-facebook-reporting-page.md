...
- **Migration number:** `20260101000153_ad_meta_funnel.sql`. `000148` is applied on hosted.
...
**Files:**
- Create: `supabase/migrations/20260101000153_ad_meta_funnel.sql`
...
Do NOT apply it. Put the assertion SQL from Task 1 Step 2 in your report; the controller applies `000153` on hosted and runs those checks. Docker and the `supabase` CLI are absent here.
...
- `ad_lead_conversions` widened with `ad_id` appended last, and `ad_meta_funnel` added by migration `20260101000153_ad_meta_funnel.sql`, with its applied-status stated accurately;
