'use client';
// Daily Command Cockpit presentational primitives — the mockup skin
// (`elevate-cockpit-mockup_1.html`) expressed as React, backed by
// cockpit.module.css. Shared by CockpitScreen and the §3/§6/§7 sub-components so
// the whole page reads as one design. No data logic lives here.
