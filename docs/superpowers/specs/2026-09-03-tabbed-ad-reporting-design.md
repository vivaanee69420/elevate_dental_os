...
**No migration is needed for any of this.** `ad_grain_rollup` and `ad_keyword_rollup` already exist and are applied (`000148`), and `ad_meta_funnel` is applied (`000156`). This piece is entirely application code.
